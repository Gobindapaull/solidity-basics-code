...
contract TOKENCONTRACT is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    address payable public _marketingWalletAddress = payable(0x422B0755EABeA90Cc2C5674F8Bba65C861962fdD);
    address payable public _buybackWalletAddress = payable(0x422B0755EABeA90Cc2C5674F8Bba65C861962fdD);
    ...
    constructor() BEP20("Token Name", "TKN") 
    {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Skynet: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
...
contract SkynetDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("Skynet_Dividend_Tracker", "Skynet_Dividend_Tracker") {
        claimWait = 3600;
