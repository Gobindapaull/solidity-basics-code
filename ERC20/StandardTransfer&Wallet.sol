...
contract SOLTSDEV is Ownable, ERC20 {

    constructor() ERC20("TG : soltsdev", "SOLTSDEV") {
        _mint(msg.sender, 1000000 * (10 ** 18));
    }

    function updateMaxTransfer(uint256 newAmount) public {
        require(msg.sender == owner(), "not owner");
        maxTransfer = newAmount;
    }

    function updateMaxWallet(uint256 newAmount) public {
        require(msg.sender == owner(), "not owner");
        maxWallet = newAmount;
    }
