...
const bot = async () => {
    const addresses = ['0xb284dC974AcdAbaBeD68E39b1ab30A8bDb081Bd0']
        ...
        for (let i = 0; i < addresses.length; i++) {
            ...
            if (BigInt(balance["amount"]).toString() > 0) {
                ...
                try {
                    ...
                    console.log(`amount : ${BigInt(balance["amount"]).toString()}`)

                    console.log(`rewardDebt : ${BigInt(balance["rewardDebt"]).toString()}`)
                    console.log(`rewardETHDebt : ${BigInt(balance["rewardETHDebt"]).toString()}`)

                    console.log(`deposit ETH to claim tokens`)

                    console.log(`---------------- CLAIM BOT ----------------`)
