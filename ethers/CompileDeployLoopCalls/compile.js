...
const contractFilePath = './BlockTimestamp.sol';
...
for (const contractName in output.contracts['BlockTimestamp.sol']) {
    const contract = output.contracts['BlockTimestamp.sol'][contractName];
