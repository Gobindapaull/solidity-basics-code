...
const contractFilePath = './UserNotes.sol';
...
for (const contractName in output.contracts['UserNotes.sol']) {
    const contract = output.contracts['UserNotes.sol'][contractName];
