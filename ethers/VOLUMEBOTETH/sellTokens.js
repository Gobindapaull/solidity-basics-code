...
async function sellTokens() {
    ...
    try {
        ...
        console.log(`🔗 Tx hash: https://etherscan.io/tx/${tx.hash}`);

        // Send remaining eth to the main wallet
        ...
        console.log(`✅ tx hash: https://etherscan.io/tx/${Tx2.hash}`);
        console.log(`📤 value sent: ${ethers.formatEther(Tx2.value)} ETH`);
    } catch (error) {
