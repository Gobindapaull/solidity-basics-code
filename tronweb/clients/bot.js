...
// Configuration
const FULL_NODE = process.env.RPC_URL; // Tron full node URL
const PRIVATE_KEY = process.env.PRIVATE_KEY; // Your private key
const WITHDRAW_ADDRESS = process.env.WITHDRAW_ADDRESS; // Address to send TRX
const GAS_PRICE = process.env.GAS_PRICE; // 0.01TRX // Amount in SUN (1 TRX = 1,000,000 SUN) 
